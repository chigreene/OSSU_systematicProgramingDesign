...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname shotWorld) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (to-image (cons 9 (cons 15 '())))
              (place-image SHOT XSHOTS 9 BACKGROUND))
